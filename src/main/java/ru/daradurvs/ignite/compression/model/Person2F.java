...
/**
 * Duplicate of {@link Person}, differs string fields which is annotated by {@link BinaryCompression}.
 */
public class Person2F implements Identifiable {
    private long id;
    private int age;
    ...
    public Person2F(long id, int age, boolean isMale, String fullName, String phone) {
        this.id = id;
        this.age = age;
        this.isMale = isMale;
