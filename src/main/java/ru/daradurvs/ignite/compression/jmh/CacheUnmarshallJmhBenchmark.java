...
public class CacheUnmarshallJmhBenchmark extends AbstractJmhBenchmark {
    public static void main(String[] args) throws RunnerException {
        Options opt = options("unmarshall.csv");
    ...
    // "unmarshall" operation with compression
    @State(Scope.Thread)
    ...
    @Benchmark
    public Object unmarshallWithCompression(IgniteCacheCompressionState state) throws IgniteCheckedException {
        return state.i.marshaller.unmarshal(state.arr, state.i.ldr);
    }
}
